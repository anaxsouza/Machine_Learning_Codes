...
# Inserção de figuras no gráfico -> comandar Shift + Enter
...
# Plotando os novos resíduos do 'modelo_step_bc_planosaude'
#com curva normal teórica
